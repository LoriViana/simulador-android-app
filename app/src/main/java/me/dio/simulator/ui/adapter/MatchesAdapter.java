...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Match match = matches.get(position); //instancia um objeto do tipo Match


        //.adapta os dados das partidas (recupera do API) para o layout
        //Glide gerencia as mídias...
    ...
    public int getItemCount() {
        return matches.size(); //mostra o tamanho da lista de partidas
    }
